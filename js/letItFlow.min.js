...
totalProgression:null,nSteps:0,nStepsName:0,dates:[],labWidth:[],progression:function(){var toDay=$.now();this.totalLength=params.lastDay-params.firstDay;if(toDay>params.firstDay)this.totalProgression=Math.abs((toDay-params.firstDay)/this.totalLength)*100;else this.totalProgression=0;this.totalPercents=this.totalProgression.toFixed(0);views.barUpdateViews()},getSteps:function(obj){this.nSteps=params.steps.length;for(var i=0;i<this.nSteps;i++){if(obj[i]){if(obj[i].stepName){stepName=obj[i].stepName;
